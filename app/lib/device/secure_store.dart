...
class SecureStore {
  ...
  Future<void> setDeviceKey(String key) => _storage.write(key: 'device_key', value: key);
  Future<String?> getDeviceKey() => _storage.read(key: 'device_key');
  Future<void> setDeviceToken(String token) => _storage.write(key: 'device_token', value: token);
  Future<String?> getDeviceToken() => _storage.read(key: 'device_token');
  Future<void> setOrgId(String orgId) => _storage.write(key: 'org_id', value: orgId);
  Future<String?> getOrgId() => _storage.read(key: 'org_id');
  Future<void> setSiteId(String siteId) => _storage.write(key: 'site_id', value: siteId);
  Future<String?> getSiteId() => _storage.read(key: 'site_id');
  Future<void> setDeviceId(String deviceId) => _storage.write(key: 'device_id', value: deviceId);
